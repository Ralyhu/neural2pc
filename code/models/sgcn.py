...
class SignedGCN(torch.nn.Module):
    ...
    def __init__(self, in_channels, hidden_channels, num_layers, n_nodes, gamma=1.0, lamb=5,
        ...
        #self.conv3_bn = torch.nn.BatchNorm1d(hidden_channels)
        #self.conv4_bn = torch.nn.BatchNorm1d(hidden_channels)
    ...
    def reset_parameters(self):
        ...
        #self.conv3_bn.reset_parameters()
        #self.conv4_bn.reset_parameters()

        
        self.lin0.reset_parameters()
        self.lin1.reset_parameters()
        self.lin2.reset_parameters()
        #self.lin3.reset_parameters() # to rem

        #self.gat_final_pos.reset_parameters()
        #self.gat_final_neg.reset_parameters()
    ...
    def forward(self, x, pos_edge_index, neg_edge_index):
        ...
        #z = torch.relu(self.conv1(x, pos_edge_index, neg_edge_index))
        #z = torch.nn.functional.selu(self.conv1(x, pos_edge_index, neg_edge_index))
        for conv in self.convs:
            #z = torch.nn.functional.leaky_relu(conv(z, pos_edge_index, neg_edge_index))
